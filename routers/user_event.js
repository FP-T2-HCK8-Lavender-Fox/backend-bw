...
user_event
  ...
  .get("/user-event/inactive", usersAuth, userEventController.getInactiveUserEventsByUserId)
  .get("/users-event/category", usersAuth, userEventController.getUserEventsByCategoryId)
