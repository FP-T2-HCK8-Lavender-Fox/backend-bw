...
friendship
  ...
  .get("/friends/request", usersAuth, friendshipController.getFriendsToAcceptLists)
  .get("/friends/pending", usersAuth, friendshipController.pendingFriendships)
  .delete("/friends/decline/:id", usersAuth, friendshipController.ignoreOrDeclineFriend)
